...
function Ronin:mySpells()
	...
	self.W = { range = 500, width = myHero:GetSpellData(_W).width, collision = false, delay = 0.15, speed = myHero:GetSpellData(_W).speed }
	self.E = { range = 625, width = myHero:GetSpellData(_E).width, delay = 0.15, speed = myHero:GetSpellData(_E).speed }
	self.R = { range = 25000, width = myHero:GetSpellData(_R).width, delay = 0.15, speed = math.huge }
end
